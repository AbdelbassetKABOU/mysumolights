...
class TrafficSignalController:
    ...
    def __init__(self, conn, tsc_id, mode, netdata, red_t, yellow_t):
        #print ('        TrafficSignalController [__init__]')
        self.conn = conn
        self.id = tsc_id
    ...
    def run(self):
        #print ('        TrafficSignalController [run]')
    ...
    def get_intermediate_phases(self, phase, next_phase):
        # print ('        TrafficSignalController [get_intermediate_phases] $$$')
    ...
    def get_subscription_data(self):
        # print ('        TrafficSignalController [get_subscription_data]')
    ...
    def get_tl_green_phases(self):
       #print ('        TrafficSignalController [get_tl_green_phases]')
    ...
    def phase_lanes(self, actions):
        #print ('        TrafficSignalController [phase_lanes(self, actions)]')
