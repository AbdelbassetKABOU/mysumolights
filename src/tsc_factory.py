...
from src.trafficsignalcontrollers.sunpressuretsc import SunPressureTSC
from src.trafficsignalcontrollers.normpressuretsc import NormPressureTSC
...
def tsc_factory(tsc_type, tl, args, netdata, rl_stats, exp_replay, neural_network, eps, conn):
    ...
    elif tsc_type == 'sunpressure':
        return SunPressureTSC(conn, tl, args.mode, netdata, args.r, args.y,
                              args.g_min )

    elif tsc_type == 'normpressure':
        return NormPressureTSC(conn, tl, args.mode, netdata, args.r, args.y,
                              args.g_min )
