...
for i in {1} 
do
    python run.py -sim double -n 1 -tsc maxpressure -nogui -mode test -gmin 5 
    # python run.py -sim double -n 1 -tsc sunpressure -nogui -mode test -gmin 5 
    # python run.py -sim double -n 1 -tsc normpressure -nogui -mode test -gmin 5 
